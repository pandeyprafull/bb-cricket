 ...
 */
router.get('/matches', Controllers.BasketBall.Match.getActiveMatches);


router.get('/joined/matches',

    (req, res, next) => {
        Controllers.BasketBall.Match.getJoinedMatches({
            user: req.user,
...
router.get('/matches/players',
    ...
    (req, res, next) => {
        Controllers.BasketBall.Match.getMatchPlayersList({
...
router.get('/fullFantasyScore',
    ...
    //route Controller
    Middlewares.CustomValidMsg.errorHandle,
    Controllers.BasketBall.Match.getFullfantasyScoreBoard);
...
router.post('/playerInfo',
    ...
    Middlewares.CustomValidMsg.errorHandle,
    (req, res, next) => {
        Controllers.BasketBall.Match.playerInfo({
...
router.post('/team',
    ...
    //route Controller
    Middlewares.CustomValidMsg.errorHandle,
    Controllers.BasketBall.Match.createTeam);
...
router.post('/team/update',
    ...
    //route Controller
    Middlewares.CustomValidMsg.errorHandle,
    Controllers.BasketBall.Match.updateTeams);
...
router.post('/swapTeam',
    ...
    Middlewares.CustomValidMsg.errorHandle,
    (req, res, next) => {
        Controllers.BasketBall.Match.swapTeam({
...
router.get('/leagues/:match_key/:fantasyType',
    ...
    Controllers.BasketBall.Match.getMatchLeagues);
...
router.get('/joined/leagues',
    ...
    Controllers.BasketBall.Match.getUserJoinedLeaguesPermatch);
...
router.get('/joined/teams',
    ...
    Controllers.BasketBall.Match.getJoinedLeagueUsersOfMatch);
...
router.post('/join',
    ...
    //route Controller
    Middlewares.CustomValidMsg.errorHandle,
    Controllers.BasketBall.Leagues.joinLeague)
...
router.post('/league/preview',
    ...
    Controllers.BasketBall.Leagues.joinLeaguePreview);
...
router.post('/league/create',
    ...
    Controllers.BasketBall.Match.createPrivateLeague);
...
router.post('/league/code',
    ...
    Controllers.BasketBall.Leagues.leagueByCode);
...
router.post('/leaguecatagory',
    ...
    //route Controller
    Middlewares.CustomValidMsg.errorHandle,
    Controllers.BasketBall.Leagues.getMatchV1Category);
